...
class Serial_com(Node):
    def __init__(self):
        ...
        self.encoder_left = self.create_publisher(Int32, "left_tick", qos_profile=1)
        self.encoder_right = self.create_publisher(Int32, "right_tick", qos_profile=1)
        self.ultrasonic = self.create_publisher(Int32MultiArray, "ultrasonic", qos_profile=1)
